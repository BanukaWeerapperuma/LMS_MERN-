      ...
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-[30px] pt-20 text-left bg-gradient-to-b from-cyan-100/70">
        ...
        <div className="max-w-course-card z-10 w-full shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            >{isAlreadyEnrolled ? "Continue Learning" : "Enroll Now"}</button>

            <div className="pt-6">
              <p className="md:text-xl text-lg font-medium text-gray-800">What's in the course?</p>
              <ul className="list-disc md:text-default ml-4 pt-2 text-gray-500">
                <li>Life time access with free updates</li>
                <li>Step by step project based learning</li>
                <li>Downloadable resources and sourse code</li>
                <li>Quizzers and test your knowledge</li>
